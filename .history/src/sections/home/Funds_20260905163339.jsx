...
export default function Funds() {
  return (
    <section className="relative min-h-[960px] overflow-hidden bg-[#0A0A0A] text-white">
      <div
      ...
      <div className="relative z-10 mx-auto w-full max-w-[1440px] px-6 py-[80px] lg:px-[80px]">
        <div className="w-full">
          <h2 className="font-['Instrument_Serif'] text-[48px] font-normal leading-[1.05] tracking-normal text-[#FFFFFF]">
            Expert-Managed Funds — Forex, Real Estate & Beyond
          </h2>

          <p className="mt-[14px] text-[16px] leading-[1.5] text-[#8F9A96]">
        ...
        <div className="mt-[40px] grid grid-cols-1 gap-[16px] lg:grid-cols-3">
          {funds.map((fund) => (
            <div
              key={fund.title}
              className="h-[346px] w-full rounded-[20px] border border-[#D4A853]/25 bg-[#121614]/[0.8784] p-[24px]"
            >
              ...
              <button
                type="button"
                className="mb-[14px] flex h-[41px] w-full items-center justify-center rounded-[8px] border border-[#D4A853] bg-[#0A0A0A]/55 px-0 py-[12px] text-[13px] font-medium text-[#D4A853]"
              >
                View Fund Details
              </button>
            </div>
        ...
        <div className="mt-[39px] w-full rounded-[16px] border border-white/[0.08] bg-[#121614]/80 px-[16px] py-[17px]">
