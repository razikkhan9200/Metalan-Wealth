...
>
      ...
      <div className="mx-auto max-w-[1440px] space-y-6 px-4 pb-6 pt-[88px] sm:px-6 md:py-6 lg:px-8">
        ...
        <div className="mt-4 grid grid-cols-1 gap-3 border-t border-white/[0.06] pt-5 sm:grid-cols-2 xl:grid-cols-4">
  {kpis.map((k) => (
    <div
      key={k.label}
      className="group flex min-w-0 items-center gap-3 rounded-2xl px-2 py-3 transition-all duration-200 hover:bg-white/[0.025]"
    >
      {/* Icon */}
      <div
        className={`grid h-11 w-11 shrink-0 place-items-center rounded-xl ring-1 transition-transform duration-200 group-hover:scale-105 ${ACCENT[k.tone]}`}
      >
