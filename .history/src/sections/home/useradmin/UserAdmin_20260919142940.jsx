...
const CAROUSEL =
  "mt-thin -mx-4 flex select-none snap-x snap-mandatory gap-4 overflow-x-auto overscroll-x-contain px-4 pb-5 pt-2 scroll-pl-4 sm:-mx-1 sm:px-1 sm:scroll-pl-1";
        ...
        <section data-anim="section">
          ...
          <div ref={fundsCar.ref} {...fundsCar.handlers} className={CAROUSEL}>
            {FUNDS.map((f) => {
              ...
              return (
                <article key={f.id} data-hover="lift" className={`${CARD} flex w-[272px] shrink-0 snap-start flex-col p-5 transition-colors hover:border-cyan-400/25 sm:w-[300px]`}>
                  ...
                  <button type="button" data-hover="btn" onClick={() => setModal({ type: "invest", id: f.id })} className={`${BTN.cyanSoft} mt-auto`}>
