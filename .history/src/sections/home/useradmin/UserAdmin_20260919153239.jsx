...
function OptionList({ options, value, onChange }) {
  ...
  const onPointerMove = (e) => {
    ...
    el.scrollTop = d.startTop - distance;
  };
  ...
  return (
    <div
      ...
      className="mt-thin relative grid max-h-64 gap-2 overflow-y-auto overscroll-contain pr-1 cursor-grab select-none scrollbar-hide"
    >
      {options.map((o) => (
        <button
          key={o.id}
