...
export default function HeroSection({
  ...
  return (
    <header
      data-anim="header"
      className="relative z-30 rounded-3xl border border-white/[0.08] shadow-[0_24px_70px_rgba(0,0,0,0.5)]"
    >
      {/* background layers */}
      <div
          ...
          <div className="rounded-2xl border border-white/10 bg-white/[0.05] p-4 backdrop-blur-md">
            <div className="flex items-end justify-between gap-3">
              ...
              <p className="text-right text-[11px] text-slate-500">
                Liquid {pctOf(faix, total).toFixed(1)}%
                <br />
