      ...
      <div className="mx-auto max-w-[1440px] space-y-6 px-4 pb-6 pt-[88px] sm:px-6 md:py-6 lg:px-8">
        ...
        <div className="grid gap-6 xl:grid-cols-3">
          <section data-anim="chart" className={`${CARD} p-5 sm:p-6 xl:col-span-2`}>
            ...
            <div className="mt-4 grid grid-cols-1 gap-3 border-t border-white/5 pt-4 sm:grid-cols-2 lg:grid-cols-4">
              {kpis.map((k) => (
                <div key={k.label} className="flex min-w-0 items-start gap-3">
                  ...
                  <div className="min-w-0 flex-1">
                    <p className="truncate text-xs text-slate-400">{k.label}</p>
                    <p className="truncate text-[14px] font-semibold tabular-nums text-white sm:text-[15px]">
