...
>
      ...
      <div className="mx-auto max-w-[1440px] space-y-6 px-4 pb-6 pt-[88px] sm:px-6 md:py-6 lg:px-8">
       ...
       <div className="mt-4 grid grid-cols-1 gap-3 pt-4 sm:grid-cols-2 xl:grid-cols-4">
  {kpis.map((k) => (
    <div
      key={k.label}
      className="group rounded-xl border border-white/[0.06] bg-[#0b121c] px-4 py-3.5 transition-all duration-200 hover:border-white/[0.11] hover:bg-[#0d1520]"
    >
      <div className="flex items-start justify-between gap-3">
        ...
        <div className="min-w-0">
          ...
          <div className="mt-2 flex items-baseline gap-1.5">
            <span className="truncate text-[21px] font-semibold leading-none tracking-tight text-white">
              {k.value}
            </span>
