...
function Dashboard() {
  ...
  return (
    <article
      ...
      data-hover="lift"
      className={`${CARD}
        group relative flex w-[300px] shrink-0 snap-start flex-col
        overflow-hidden border-white/[0.07]
        bg-[linear-gradient(145deg,#0b131b_0%,#071017_100%)]
      ...
      <div className="p-5">
          ...
          <div className="flex items-center gap-3">
            <div
              className={`grid h-12 w-12 shrink-0 place-items-center
                rounded-2xl ring-1 ${ACCENT.cyan}
                bg-cyan-400/[0.07]`}
            >
        ...
        <div className="mt-6 rounded-2xl border border-white/[0.06] bg-black/20 p-4">
          ...
          <div className="mt-4 h-1.5 overflow-hidden rounded-full bg-white/[0.05]">
            <div
              className="h-full rounded-full bg-gradient-to-r from-cyan-500/50 to-cyan-300"
              style={{
                width: `${Math.min(
                  Math.max(25 + Math.abs(unitChange) * 3, 25),
                  92
                )}%`,
              }}
            />
        ...
        <button
          ...
          className={`${BTN.cyanSoft}
            mt-4 w-full border-cyan-400/25
            bg-cyan-400/[0.07]
            py-3
