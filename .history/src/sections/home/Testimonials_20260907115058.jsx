...
export default function Testimonials() {
  ...
  return (
    <section
      ref={sectionRef}
      className="min-h-[667px] bg-[#0A0A0A] px-0 py-16 sm:py-20 lg:py-[100px]"
    >
      <Container>
        <div className="text-center">
          <Heading
            level={2}
            className="testimonials-heading !font-['Instrument_Serif'] !text-[48px] !font-normal !text-white"
          >
        ...
        <div className="mt-14 grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
          {TESTIMONIALS.map((testimonial) => (
            ...
            className="testimonial-card !h-[289px] !w-full !rounded-[20px] !border-[#D4A853]/30 !bg-[#121614]/[0.8784] !p-9 !shadow-none"
            >
            <div className="flex h-full flex-col gap-6">
                <span className="font-['Instrument_Serif'] text-[32px] leading-none text-[#D4A853]/40">
                “
                </span>

                <Text
                size="sm"
                className="!text-[16px] !leading-[24px] !text-[#8F9A96]"
                >
                {testimonial.quote}
                </Text>
