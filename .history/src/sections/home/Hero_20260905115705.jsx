      ...
      <div className="relative z-10 flex h-full items-center justify-center px-6">
        <div className="w-full max-w-[1100px] -translate-y-[1px] text-center">
          ...
          <div className="mt-10 flex items-center justify-center gap-5">
            <Link
              to="/login"
              className="flex h-[58px] min-w-[190px] items-center justify-center rounded-xl bg-[#D9A64A] px-8 text-[15px] font-semibold text-[#0A0A0A] shadow-[0_0_35px_rgba(217,166,74,0.4)] transition-transform duration-200 hover:scale-[1.02]"
            >
              Start Investing
            </Link>
            ...
            <Link
              to="/properties"
              className="flex h-[58px] min-w-[235px] items-center justify-center rounded-xl border border-[#D9A64A] bg-transparent px-8 text-[15px] font-semibold text-[#D9A64A] transition-colors duration-200 hover:bg-[#D9A64A]/10"
            >
              Explore Properties →
            </Link>
          </div>
