          ...
          <div>
            ...
            <div className="mt-8 grid grid-cols-1 gap-3 sm:grid-cols-2">
              {METRICS.map((metric, index) => (
                <Card
                  key={metric.label}
                  className="metric-card group relative !min-h-[110px] !overflow-hidden !rounded-[18px] !border-white/[0.08] !bg-[#111614] !p-5 !shadow-none transition-all duration-300 hover:-translate-y-1 hover:!border-[#D4A853]/30"
                >
