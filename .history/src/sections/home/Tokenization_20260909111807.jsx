    ...
    >
      ...
      <div className="relative z-10 mx-auto w-full max-w-[1480px] px-4 py-12 sm:px-5 sm:py-14 md:px-6 md:py-16 lg:px-10 lg:py-20 xl:px-20">
        <div className="w-full max-w-[1320px]">
          ...
          <div className="tokenization-card h-auto min-h-[380px] w-full max-w-full rounded-[22px] border border-[#D4A853] bg-[#121614]/[0.8784] p-4 shadow-[0_4px_24px_0_#D4A853] sm:p-5 lg:col-span-1 xl:col-span-1 xl:h-[400px] xl:w-[370px]">
