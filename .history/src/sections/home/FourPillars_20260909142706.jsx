            ...
            return (
              ...
              >
               <img
                src={pillar.image}
                alt={pillar.title}
                className="h-[120px] w-full object-cover sm:h-[130px] lg:h-[140px]"
              />

                <div className="p-4 sm:p-5">
                <div className="flex h-7 w-7 items-center justify-center rounded-full border border-[#D4A853] bg-[#1A3C34]">
                  <Icon
                    size={13}
                    strokeWidth={2}
                 ...
                 <Heading
                    level={3}
                    className="mt-3 !font-['Instrument_Serif'] !text-[16px] !font-normal !leading-[1.15] !text-white"
                  >
                    {pillar.title}
                  </Heading>
                ...
                <Text
                  size="sm"
                  className="mt-2 line-clamp-2 !text-[11.5px] !leading-[17px] !text-[#8F9A96]"
                >
                  {pillar.description}
                </Text>
                  ...
                  <div className="mt-2 flex flex-wrap gap-1.5">
                      ...
                      <span
                        key={badge}
                        className="rounded-full border border-[#D4A853]/30 bg-[#0A0A0A] px-2.5 py-0.5 text-[10px] font-medium text-[#D4A853]"
                      >
                        {badge}
                      </span>
                    ))}
                ...
                <Link
                      to="#"
                      className="mt-2 flex h-7 w-full items-center justify-center rounded-xl border border-[#D4A853]/30 text-[10.5px] font-semibold text-[#D4A853] transition-colors duration-200 hover:bg-[#D4A853]/10"
                    >
                    {pillar.button}
                  </Link>
                </div>
