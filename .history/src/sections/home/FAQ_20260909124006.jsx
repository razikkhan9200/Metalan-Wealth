  ...
  return (
    ...
    >
      ...
      <Container className="relative z-10 flex items-center">
        <div className="grid w-full grid-cols-1 gap-12 py-20 lg:grid-cols-[0.9fr_1.1fr] lg:gap-16 lg:py-[100px]">
          <div className="faq-left max-w-[500px]">
            <div className="mb-5 h-px w-16 bg-[#D4A853]" />

            <Heading
              level={2}
              className="!font-['Instrument_Serif'] !text-[48px] !font-normal !leading-[1.1] !text-white"
            >
