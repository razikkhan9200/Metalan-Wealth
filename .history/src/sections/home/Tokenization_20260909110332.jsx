    ...
    >
      ...
      <div className="relative z-10 mx-auto w-full max-w-[1480px] px-4 py-12 sm:px-5 sm:py-14 md:px-6 md:py-16 lg:px-10 lg:py-20 xl:px-20">
        <div className="w-full max-w-[1320px]">
          ...
          <div className="tokenization-main mt-8 grid grid-cols-1 items-start gap-6 sm:mt-10 lg:grid-cols-2 lg:gap-6 xl:mt-10 xl:grid-cols-[minmax(300px,370px)_minmax(280px,400px)_minmax(320px,400px)] xl:gap-8">
            <div className="tokenization-visual h-[270px] w-full overflow-hidden rounded-[22px] bg-[#121614] sm:h-[330px] lg:h-[400px] lg:w-[320px]">
              <img
              ...
              />
                    ...
                    <div className="flex h-auto w-full max-w-[420px] flex-col gap-5 lg:w-full xl:h-[592px] xl:w-full">
            {steps.map((step) => (
                <div
                key={step.number}
          ...
          <div className="tokenization-card h-auto min-h-[400px] w-full max-w-full rounded-[22px] border border-[#D4A853] bg-[#121614]/[0.8784] p-4 shadow-[0_4px_24px_0_#D4A853] sm:p-5 lg:col-span-2 xl:col-span-1 xl:h-[410px] xl:w-[400px]">
              <div className="h-[125px] sm:h-[140px] w-full overflow-hidden rounded-[12px] bg-[#121614]">
                <img
              ...
              <div className="mt-[16px]">
                ...
                <button
                  type="button"
                  className="mt-[14px] flex h-[44px] w-full items-center justify-center rounded-[12px] bg-[#D4A853] text-[14px] !font-[700] text-[#0A0A0A]"
                >
                  Invest Now
                </button>
              </div>
