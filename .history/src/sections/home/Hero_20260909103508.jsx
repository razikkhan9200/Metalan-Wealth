...
export default function Hero() {
  ...
  return (
        <section
          ref={heroRef}
        className="relative min-h-[700px] overflow-hidden bg-[#0A0A0A] text-white sm:min-h-[800px] lg:h-[900px] lg:min-h-0"
        >
        <div
          className="absolute left-0 top-0 h-[780px] w-full bg-cover bg-center bg-no-repeat"
          style={{
        ...
        <div className="absolute left-0 top-0 h-[780px] w-full bg-black/50" />
