...
const PILLARS = [
  ...
  {
    image: "/images/token-exchange.png",
    icon: ArrowLeftRight,
          ...
          {PILLARS.map((pillar) => {
            ...
            return (
              ...
              >
                ...
                <div className="p-6">
                  <div className="flex h-9 w-9 items-center justify-center rounded-full border border-[#D4A853] bg-[#1A3C34]">
                    <Icon
                      size={16}
                      strokeWidth={2}
                  ...
                  <Heading
                    level={3}
                    className="mt-4 !font-['Instrument_Serif'] !text-[22px] !font-normal !leading-[1.1] !text-white"
                  >
                    {pillar.title}
                  </Heading>
                  ...
                  <Text
                    size="sm"
                    className="mt-3 !text-[13px] !leading-[20px] !text-[#8F9A96]"
                  >
                    {pillar.description}
                  </Text>
