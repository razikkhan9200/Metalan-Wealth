      ...
      <div className="relative z-10 flex h-full items-center justify-center px-6">
        <div className="w-full max-w-[1100px] -translate-y-[1px] text-center">
          ...
          <div className="mt-10 flex items-center justify-center gap-5">
            <Link
              to="/login"
              className="hero-button flex h-[57px] w-[190px] items-center justify-center rounded-[12px] bg-gradient-to-r from-[#D4A853] to-[#B87333] text-[15px] !font-[700] !text-[#0A0A0A] shadow-[0_6px_24px_0_#B87333] transition-transform duration-200 hover:scale-[1.02]"
            >
              Start Investing
            </Link>
            ...
            <Link
              to="/properties"
              className="hero-button flex h-[57px] w-[235px] items-center justify-center rounded-[12px] border-[1.5px] border-[#B87333] bg-transparent px-8 text-[15px] font-semibold !text-[#D4A853] transition-colors duration-200 hover:bg-[#D4A853]/10"
            >
              Explore Properties →
            </Link>
          </div>
