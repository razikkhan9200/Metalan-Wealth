    ...
    <footer className="bg-[#0A0A0A] text-white">
      <Container>
        <div className="border-t border-white/[0.08] py-12 sm:py-14 lg:py-16">
          <div className="grid grid-cols-1 gap-12 lg:grid-cols-[1.4fr_1fr_1fr_1fr_1fr] lg:gap-10">
            <div className="max-w-[360px]">
              <div className="flex items-center gap-3">
                <div className="flex h-9 w-9 items-center justify-center rounded-[8px] border border-[#D4A853] bg-[#1A3C34] font-['Instrument_Serif'] text-[20px] text-[#D4A853]">
                  M
                </div>
              ...
              <Text
                size="sm"
                className="mt-1 !text-[12px] !leading-[18px] !text-[#8F9A96]"
              >
          ...
          <div className="mt-12 border-t border-white/[0.08] pt-7">
            <div className="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
              <Text
                size="sm"
                className="!text-[13px] !text-[#8F9A96]"
              >
                ...
                {SOCIALS.map((social) => {
                  ...
                  return (
                    <a
                      ...
                      className="flex h-9 w-9 items-center justify-center rounded-[10px] border border-[#D4A853]/25 text-[#D4A853] transition-all duration-200 hover:border-[#D4A853]/60 hover:bg-[#D4A853]/10"
                    >
