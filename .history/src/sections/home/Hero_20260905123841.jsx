...
export default function Hero() {
  return (
    <section className="relative h-[900px] overflow-hidden bg-[#0A0A0A] text-white">
      <div
      ...
      <div className="relative z-10 flex h-full items-center justify-center px-6 pt-[88px]">
        <div className="w-full max-w-[1100px] text-center">
          ...
          <div className="mt-10 flex items-center justify-center gap-5">
            ...
            >
              <span className="flex h-full w-full items-center justify-center rounded-[10.5px] bg-[#07100D] text-[15px] font-semibold text-[#D4A853]">
                Explore Properties →
              </span>
            </Link>
          </div>
          ...
          <div className="mt-14 flex items-center justify-center gap-5">
            <div className="rounded-full border border-[#D4A853]/45 bg-[#07100D]/75 px-6 py-2.5 text-[13px] font-medium text-[#D4A853] shadow-[0_0_18px_rgba(217,166,74,0.35)] backdrop-blur-md">
              ₣2.4B+ Tokenized
            </div>
