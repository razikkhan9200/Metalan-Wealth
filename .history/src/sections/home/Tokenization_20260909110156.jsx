    ...
    >
      ...
      <div className="relative z-10 mx-auto w-full max-w-[1480px] px-4 py-12 sm:px-5 sm:py-14 md:px-6 md:py-16 lg:px-10 lg:py-20 xl:px-20">
        <div className="w-full max-w-[1320px]">
          ...
          <div className="tokenization-main mt-8 grid grid-cols-1 items-start gap-6 sm:mt-10 lg:grid-cols-2 lg:gap-6 xl:mt-10 xl:grid-cols-[minmax(300px,370px)_minmax(300px,420px)_minmax(340px,440px)] xl:gap-8">
