      ...
      <div className="relative z-10 mx-auto w-full max-w-[1480px] px-4 py-12 sm:px-5 sm:py-14 md:px-6 md:py-16 lg:px-10 lg:py-20 xl:px-20">
        <div className="w-full max-w-[1320px]">
          ...
          <div className="tokenization-main mt-8 grid grid-cols-1 items-start gap-6 sm:mt-10 lg:grid-cols-[minmax(280px,1fr)_minmax(260px,1.1fr)_minmax(300px,1fr)] lg:gap-6 xl:mt-10 xl:grid-cols-[minmax(300px,370px)_minmax(280px,400px)_minmax(320px,400px)] xl:gap-8">
            <div className="tokenization-visual h-[240px] w-full overflow-hidden rounded-[22px] bg-[#121614] sm:h-[290px] lg:h-[400px] w-full">
              <img
          ...
          <div className="tokenization-card h-auto min-h-[350px] w-full max-w-full rounded-[22px] border border-[#D4A853] bg-[#121614]/[0.8784] p-4 shadow-[0_4px_24px_0_#D4A853] sm:p-4 lg:col-span-1 xl:col-span-1 xl:h-[400px] xl:w-[370px]">
