...
export default function PlatformFeatures() {
  return (
    <section className="min-h-[800px] bg-[#0A0A0A] py-16 sm:py-20 lg:h-[800px] lg:py-[100px]">
      <Container className="h-full px-5 sm:px-6 lg:px-8">
        <div className="text-center">
          <Heading
            level={2}
            className="font-['Instrument_Serif'] text-[38px] font-normal leading-[1.1] text-white sm:text-[46px] lg:text-[52px]"
          >
          ...
          <Text
            size="sm"
            className="mx-auto mt-5 max-w-[650px] !text-[#8F9A96] sm:text-base"
          >
        ...
        <div className="mt-12 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:mt-14 lg:grid-cols-3">
          {FEATURES.map((feature) => {
            ...
            return (
             <Card
                key={feature.title}
                className="min-h-[210px] !rounded-[16px] !border-white/[0.10] !bg-[#101412] !p-8 !shadow-none"
                >
                ...
                <Heading
                  level={3}
                  className="mt-5 font-['Instrument_Serif'] text-[21px] font-normal text-white"
                >
                  {feature.title}
                </Heading>
                ...
                <Text
                  size="sm"
                  className="mt-3 max-w-[350px] !text-[#919A96] !leading-[1.55]"
                >
                  {feature.description}
                </Text>
              </Card>
