...
export default function Hero() {
  ...
  <Link
    to="/login"
    className="flex h-[57px] w-[190px] items-center justify-center rounded-[12px] bg-gradient-to-r from-[#D4A853] to-[#B87333] text-[15px] font-semibold text-[#0A0A0A] shadow-[0_0_35px_rgba(217,166,74,0.4)] transition-transform duration-200 hover:scale-[1.02]"
  >
    Start Investing
  </Link>
