          ...
          {PILLARS.map((pillar) => {
            ...
            return (
              ...
              />
                ...
                <Link
                  to="#"
                  className="mt-3 flex h-8 w-full items-center justify-center rounded-xl border border-[#D4A853]/30 text-[11px] font-semibold text-[#D4A853] transition-colors duration-200 hover:bg-[#D4A853]/10"
                >
                    {pillar.button}
                  </Link>
                </div>
