        ...
        <div className="mt-[40px] grid grid-cols-1 gap-[16px] lg:grid-cols-3">
          {funds.map((fund) => (
            ...
            >
              ...
              <button
                type="button"
                className="mb-[12px] flex h-[41px] w-full items-center justify-center rounded-[8px] border border-[#D4A853] bg-[#0A0A0A]/55 px-0 py-[12px] text-[13px] font-medium text-[#D4A853]"
              >
                View Fund Details
              </button>
            </div>
