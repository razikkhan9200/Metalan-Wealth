...
export default function Tokenization() {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 mx-auto w-full max-w-[1480px] px-4 py-12 sm:px-5 sm:py-14 md:px-6 md:py-16 lg:px-10 lg:py-20 xl:px-20">
        <div className="w-full max-w-[1320px]">
          <h2 className="tokenization-heading font-['Instrument_Serif'] text-[28px] font-normal leading-[1.05] tracking-normal text-[#FFFFFF] xs:text-[34px] sm:text-[40px] md:text-[44px] lg:text-[48px]">
          ...
          {/*
            Responsive grid roadmap:
            - base (phone):   1 column, everything stacked
            - md (≥768px):    2 columns (visual + steps on top row, card spans full width below)
            - lg (≥1024px):   3 columns side by side
            - xl (≥1280px):   3 columns with the original fixed sizing
          */}
          <div className="tokenization-main mt-8 grid grid-cols-1 items-start gap-6 sm:mt-10 md:grid-cols-2 md:gap-6 lg:grid-cols-[minmax(280px,1fr)_minmax(260px,1.1fr)_minmax(300px,1fr)] lg:gap-6 xl:mt-10 xl:grid-cols-[minmax(300px,370px)_minmax(280px,400px)_minmax(320px,400px)] xl:gap-8">
            ...
            <div className="flex h-auto w-full flex-col gap-4 sm:gap-5 lg:max-w-[420px] xl:min-h-[592px]">
              {steps.map((step) => (
                <div
                  key={step.number}
                ...
                >
                  ...
                  <div className="pt-0.5">
                    ...
                    <p className="mt-1 text-[13px] leading-[1.3] text-[#8F9A96]">
                      {step.text}
                    </p>
                  </div>
                </div>
            ...
            <div className="tokenization-card col-span-1 h-auto min-h-[350px] w-full max-w-full rounded-[22px] border border-[#D4A853] bg-[#121614]/[0.8784] p-4 shadow-[0_4px_24px_0_#D4A853] sm:p-4 md:col-span-2 lg:col-span-1 xl:min-h-[400px] xl:w-[370px]">
              <div className="h-[130px] w-full overflow-hidden rounded-[12px] bg-[#121614] sm:h-[125px] lg:h-[140px]">
                <img
              ...
              <div className="mt-[12px] sm:mt-[16px]">
                ...
                <div className="mt-[8px] flex flex-wrap items-center justify-between gap-y-1">
                ...
                <div className="mt-[16px] flex flex-wrap items-center justify-between gap-y-1">
                  <span className="text-[11px] font-normal text-[#8F9A96]">
                    3,200 of 4,800 sold
                  </span>
                ...
                <div className="mt-[16px] flex items-start justify-between">
                  <div>
                    <p className="text-[10px] text-[#8F9A96]">Est. Yield</p>
                  ...
                  <div className="text-right">
                    <p className="text-[10px] text-[#8F9A96]">Next Payout</p>
