        ...
        <nav className="ml-[120px] hidden h-full items-center gap-[39px] lg:flex">
          {navigation.map((item) => (
            <NavLink
              key={item.label}
              to={item.href}
              className="text-[13px] font-medium text-[#8F8F8A] transition-colors hover:text-white"
            >
              {item.label}
            </NavLink>
          ))}
          ...
          <nav className="mx-auto flex max-w-7xl flex-col gap-5">
            {navigation.map((item) => (
              <NavLink
                ...
                className="text-[14px] font-medium !text-[#8F8F8A] transition-colors hover:!text-white"
              >
                {item.label}
              </NavLink>
            ))}
