...
export default function PublicNavbar() {
  ...
  return (
    <header className="sticky top-0 z-50 w-full border-b border-white/[0.06] bg-[#121212]/80 text-white backdrop-blur-xl">
      <div className="mx-auto flex h-[88px] w-full max-w-[1280px] items-center px-6 lg:px-8">
        <Link
          to={ROUTES.HOME}
          className="flex shrink-0 items-center gap-3"
        >
          <div className="flex h-[40px] w-[40px] items-center justify-center rounded-[10px] border border-[#D4A853] bg-[#afaf21]">
