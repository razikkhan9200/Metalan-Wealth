...
export default function PublicNavbar() {
  ...
  className="flex shrink-0 items-center gap-3"
>
  <div className="flex h-10 w-10 items-center justify-center rounded-[10px] border border-[#d9a64a] bg-[#151515] font-serif text-[18px] text-[#d9a64a]">
    M
  </div>

  <span className="font-serif text-[16px] leading-none text-[#f5f1e8]">
    METALAN WEALTH
  </span>
</Link>
            ))}
