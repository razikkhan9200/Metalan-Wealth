...
export default function NavigationPanel({
  ...
  const displayName = String(userName || "Investor").trim() || "Investor";
          ...
          >
            <div
              className={`
                ...
                overflow-hidden rounded-full border border-[#D4AF6A]/40
                ${avatarFailed || !profileImage ? (isDark ? "bg-[#0A1019]" : "bg-white") : ""}
              `}
            >
              {profileImage && !avatarFailed ? (
                ...
                <span
                  aria-hidden="true"
                  className="font-semibold text-[13px] tracking-wide text-[#D4AF6A]"
                >
                  {displayInitials}
                </span>
              )}
