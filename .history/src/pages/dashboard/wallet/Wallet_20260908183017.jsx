    ...
    <div className="min-h-screen w-full bg-[#0a0910] pb-16">
      ...
      <main className="mx-auto max-w-7xl px-4 pt-8 sm:px-6 lg:px-10">
        ...
        <div className="mt-6 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
          {QUICK_ACTIONS.map((action) => (
            <button
              ...
              className="rounded-2xl border border-white/10 bg-white/[0.02] p-5 text-left transition-colors hover:border-white/20"
            >
              <span
        ...
        {/* ============================================================
            TRANSACTION HISTORY
        ============================================================ */}
        <div className="mt-6 rounded-3xl border border-white/10 bg-white/[0.015] p-6 sm:p-8">
          <div>
