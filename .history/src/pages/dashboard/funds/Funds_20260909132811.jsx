        ...
        <div className="mt-6 grid grid-cols-1 gap-6 lg:grid-cols-3">
          <div className="lg:col-span-2">
            ...
            {visibleFunds.length > 0 ? (
              ...
              <div className="mt-5 flex flex-col items-center justify-center rounded-2xl border border-white/10 bg-[#18211E] py-16 text-center">
...
function FundCard({ fund, onViewFund }) {
  return (
    <div className="rounded-2xl border border-white/10 bg-[#18211E] p-5 transition-colors hover:border-white/20">
