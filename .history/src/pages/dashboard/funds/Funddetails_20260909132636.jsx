  ...
  return (
    <div className="min-h-screen w-full bg-[#0E1211] pb-16">
      ...
      <main className="mx-auto max-w-7xl px-4 pt-6 sm:px-6 lg:px-10">
        ...
        ============================================================ */}
        <div className="rounded-2xl border border-white/10 bg-[#18211E] p-6 sm:p-8">
        ...
        <div className="mt-6 grid grid-cols-1 gap-6 lg:grid-cols-3">
          ...
          <div className="flex flex-col gap-6 lg:col-span-2">
            ...
            <div className="rounded-2xl border border-white/10 bg-[#18211E] p-5 sm:p-6">
...
function StatBox({ label, value, tone = "default" }) {
  return (
    <div className="rounded-xl border border-white/10 bg-[#18211E] p-4">
