            ...
            <div data-anim="section" className={`${CARD} overflow-hidden`}>
              <div className="border-b border-white/[0.06] px-5 py-4">
                <div className="flex items-center justify-between gap-3">
                  ...
                  <span className="grid h-9 w-9 shrink-0 place-items-center rounded-xl ring-1 ${ACCENT.gold}">
              ...
              <div className="divide-y divide-white/[0.05]">
                {topFunds.map((fund, i) => (
                  <div key={fund.id} className="flex items-center gap-3 px-5 py-3.5 transition-colors hover:bg-white/[0.03]">
                    ...
                    <div className="relative h-10 w-10 shrink-0 overflow-hidden rounded-xl bg-[#0d1520]">
                      <fund.icon className="absolute left-1/2 top-1/2 h-4 w-4 -translate-x-1/2 -translate-y-1/2 text-[#d4af6a]/70" />
                      {fund.img && (
                        <Photo
                          src={fund.img}
                          alt={fund.name}
                    ...
                    <div className="shrink-0 text-right">
                      ...
                      <p className={`mt-1 text-[10px] font-medium ${fund.status === "Open" ? "text-emerald-300" : "text-[#d4af6a]"}`}>
                        {fund.status}
                      </p>
                    </div>
                  </div>
