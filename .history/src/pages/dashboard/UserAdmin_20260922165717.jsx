...
>
  ...
  {/* DATE RANGE */}
  <div className="flex w-full min-w-0 items-center rounded-xl border border-white/10 bg-white/[0.02] sm:w-auto">
    ...
    <span className="flex min-w-0 flex-1 items-center justify-center gap-2 px-1 text-center text-[11px] leading-4 text-slate-300 sm:min-w-[9.5rem] sm:text-xs">
      <CalendarDays className="h-3.5 w-3.5 shrink-0 text-[#d4af6a]" />
