...
import dashboardHero from "../../../public/images/Dashboard-images/dashboard-hero-bg.png";
// lucide-react icons
import {
  Search,
  Bell,
...
export default function Dashboard() {
  ...
  return (
    <div className="min-h-screen w-full !bg-[#0b0e0d] pb-16">
      ...
      <main className="mx-auto max-w-7xl px-4 pt-6 sm:px-6 lg:px-10">
        ...
        ============================================================ */}
          <div
            className={
              "relative mt-6 overflow-hidden rounded-3xl border border-[#e8b46a]/20 p-6 sm:p-8 " +
              CARD_HOVER
            }
          >
            <div
        ...
        ============================================================ */}
        <div className={"mt-6 rounded-2xl border border-white/10 !bg-[#18211E] p-5 sm:p-6 " + CARD_HOVER}>
        ...
        <div className="mt-6 grid grid-cols-1 gap-6 lg:grid-cols-2">
          <div className={"rounded-2xl border border-white/10 !bg-[#18211E] p-5 sm:p-6 " + CARD_HOVER}>
...
function MetricCard({ metric }) {
  ...
  return (
    <div className={"rounded-2xl border border-white/10 !bg-[#18211E] p-5 " + CARD_HOVER}>
