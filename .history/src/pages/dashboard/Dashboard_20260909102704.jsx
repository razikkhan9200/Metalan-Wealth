  ...
  return (
    <div className="min-h-screen w-full !bg-[#0A0A0A] pb-16">
      ...
      <main className="mx-auto max-w-7xl px-4 pt-6 sm:px-6 lg:px-10">
        ...
        ============================================================ */}
        <div className={"mt-6 rounded-2xl border border-white/10 !bg-[#121614] p-5 sm:p-6 " + CARD_HOVER}>
        ...
        <div className="mt-6 grid grid-cols-1 gap-6 lg:grid-cols-2">
          <div className={"rounded-2xl border border-white/10 !bg-[#121614] p-5 sm:p-6 " + CARD_HOVER}>
...
function MetricCard({ metric }) {
  ...
  return (
    <div className={"rounded-2xl border border-white/10 !bg-[#121614] p-5 " + CARD_HOVER}>
