  ...
  return (
    <div className="relative w-full sm:w-auto sm:min-w-[150px]">
      <select
        value={value}
        onChange={onChange}
        className="h-11 w-full appearance-none rounded-xl border border-white/10 bg-[#080d14] px-3.5 pr-10 text-sm font-medium text-slate-200 outline-none transition-colors hover:border-white/15 focus:border-cyan-400/50 focus:ring-1 focus:ring-cyan-400/20"
      >
        {options.map((option) => (
          <option
            key={option}
            value={option}
            className="bg-[#0a1019] text-slate-200"
          >
