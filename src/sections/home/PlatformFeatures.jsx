...
export default function PlatformFeatures() {
  ...
  return (
    <section
      ref={sectionRef}
      className="min-h-[800px] bg-[#0A0A0A] py-16 sm:py-20 lg:h-[800px] lg:py-[100px]"
    >
      <Container className="h-full">
        <div className="text-center">
          <Heading
            level={2}
            className="features-heading !font-['Instrument_Serif'] !text-[36px] !font-normal !leading-[1.1] !text-white sm:!text-[42px] lg:!text-[48px]"
          >
          ...
          <Text
            size="sm"
            className="features-description mx-auto mt-5 w-full max-w-[600px] !text-[16px] !leading-[24px] !text-[#8F9A96]"
          >
