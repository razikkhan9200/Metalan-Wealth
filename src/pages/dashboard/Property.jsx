/* pages/property/Property.jsx: application source file. Tokenized real estate marketplace. */
    ...
    <div className="min-h-screen w-full bg-[#0a0910] pb-16">
      ...
      <main className="mx-auto max-w-7xl px-4 pt-6 sm:px-6 lg:px-10">
        ...
        {/* ============================================================
            FILTER BAR
        ============================================================ */}
        <div className="mt-6 flex flex-col gap-3 rounded-2xl border border-white/10 bg-white/[0.02] p-3 sm:flex-row sm:items-center sm:justify-between sm:p-4">
